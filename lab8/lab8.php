...
//计算单品的价格
function calTheAmount( $quantity, $price){
    $amount = $price * $quantity;
    return $amount;
 }

 //计算商品总价格
 $subtotal = calTheAmount($quantity1,$price1) + calTheAmount($quantity2,$price2) + calTheAmount($quantity3,$price3) + calTheAmount($quantity4,$price4);
